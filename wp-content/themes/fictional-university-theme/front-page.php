...
<div class="page-banner">
    <div class="page-banner__bg-image"
        style="background-image: url(<?php echo get_theme_file_uri("/images/library-hero2.jpg") ?>)"></div>
                ...
                ?>
                    <div class="event-summary">
                        ...
                        <div class="event-summary__content">
                            ...
                            <p><?php echo (has_excerpt()) ? get_the_excerpt() : wp_trim_words(get_the_content(), 15); ?><a
                ...
                while($homepagePosts->have_posts()) : $homepagePosts->the_post(); ?>
                    <div class="event-summary">
                        ...
                        <div class="event-summary__content">
                            ...
                            <p><?php echo (has_excerpt()) ? get_the_excerpt() : wp_trim_words(get_the_content(), 15); ?> <a href="<?php the_permalink() ?>"
                                    class="nu gray">Read more</a></p>
                        </div> 
                    </div>
            <?php endwhile; wp_reset_postdata(); //good habit to add this ?>
            <p class="t-center no-margin"><a href="<?php echo get_post_type_archive_link('post')?>" class="btn btn--yellow">View All Blog
                    Posts</a></p>
        </div>
    </div>
</div>
