        ...
        <?php
            $relatedProfessors = new WP_Query(array(
                ...
                'meta_query'        => array(
                    array(
                        ...
                        'compare'   => 'LIKE',
                        'value'     => '"' . get_the_ID() . '"' // to get value from serialize data in database
                    )
                )
            ));
            ...
            if($relatedCampuses) {
                ...
                foreach ($relatedCampuses as $campus) { ?>
                    <li>
                        <a href="<?php echo get_the_permalink();?>"><?php echo get_the_title($campus);?></a>
                    </li>    
            <?php
                }
                echo "</ul>";
